...
<div class="alert alert-info border-8 shadow-sm mb-4 mt-4">
    <strong>Note</strong>
    <p>You can mark all student</p>
</div>
    ...
    <table class="table table-hover align-middle mb-0">
        ...
        <tbody>
            ...
            <tr class="student-row">
                ...
                <td>
                    <select class="form-select" name="attendances[{{ $index }}][status_in]" id="" disabled>
                ...
                <td>
                    <select class="form-select" name="attendances[{{ $index }}][status_out]" id="" disabled>
                        <option value="">Select Status...</option>
