            ...
            <div class="card-body p-4">
                <form action="{{ route('attendance.update', $attendance->id) }}" method="post">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-select" name="status_in" id="status_in">
                                ...
                                <option value="Hadir" {{ strtolower($attendance->status_in) == 'hadir' ? 'selected' : ''
                                    }}>Hadir</option>
                                <option value="Sakit" {{ strtolower($attendance->status_in) == 'sakit' ? 'selected' : ''
                                    }}>Sakit</option>
                                <option value="Izin" {{ strtolower($attendance->status_in) == 'izin' ? 'selected' : ''
                                    }}>Izin</option>
                                <option value="Alpa" {{ strtolower($attendance->status_in) == 'alpa' ? 'selected' : ''
                                    }}>Alpa</option>
                            </select>
                        </div>
                        <div class="col-md-6 mb-3">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-select" name="status_out" id="status_out">
                                <option value="">Select Status...</option>
                                <option value="Pulang" {{ strtolower($attendance->status_out) == 'pulang' ? 'selected' :
                                    '' }}>Pulang</option>
                                <option value="Bolos" {{ strtolower($attendance->status_out) == 'bolos' ? 'selected' :
                                    '' }}>Bolos</option>
                                <option value="Izin Pulang Cepat" {{ strtolower($attendance->status_out) == 'izin pulang
                                    cepat' ? 'selected' : '' }}>Izin Pulang Cepat</option>
                            </select>
                        </div>
                        <div class="col-md-6 mb-3">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" class="form-control" name="note" id="note" placeholder="Optional..."
