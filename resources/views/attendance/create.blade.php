        ...
        <div class="col-lg-12">
            <div class="card shadow-sm border-8">
                <div class="card-header bg-white d-flex justify-content-between align-items-center py-2">
                    <h5 class="mb-0 fw-bold text-primary">Input Attendence (Bulk)</h5>
                ...
                <div class="card-body p-4">
                    <form action="{{ route('attendance.store') }}" method="POST">
                        ...
                        <div class="texr-end">
                            ...
                            <button type="submit" class="btn btn-primary px-4 fw-bold shadow-sm" id="btn-save">Save Attendance</button>
                        </div>
                    </form>
                </div>
            </div>
